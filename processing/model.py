...
class BERTModel(nn.Module):
    def __init__(self,input_d:int = 232 , d_model:int = 512, nhead: int=8, d_hid:int=2048,n_layers:int=6,dropout:float=.5,seq_length=128,classification=False):
        super().__init__()
        ...
        if not self.classification:
            ...
            self.prob4 = nn.Linear(d_model*seq_length*2,bias=False)
