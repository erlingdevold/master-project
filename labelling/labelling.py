...
if __name__ == "__main__":
    ...
    if os.path.exists("labelling/dca_labels_subset.nc"):
        ...
        print(all_labels)
        labels_to_select = ["Starttidspunkt","Startdato","Stopptidspunkt","Stoppdato","Startposisjon bredde","Havdybde start","Rundvekt","Havdybde stopp","Melding ID","Meldingstidspunkt","Startposisjon lengde","Stopposisjon bredde","Stopposisjon lengde","Art FAO", "Hovedart FAO"]
